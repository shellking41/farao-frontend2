...
function RoomPage() {
  ...
  const leaveRoom = async () => {
    try {
      console.log(roomId);
      const userData = await post('https://api.szabolcsbabics.com/room/leave', { roomId }, token);
  ...
  const addBot = async () => {
    try {
      ...
      const response = await post(
        'https://api.szabolcsbabics.com/bot/add',
        {
  ...
  const startGame = async () => {
    try {
      const response = await post('https://api.szabolcsbabics.com/game/start', { roomId }, token);
    } catch (e) {
      console.error(e);
    }
  };
